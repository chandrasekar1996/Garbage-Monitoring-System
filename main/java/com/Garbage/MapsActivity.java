...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    private static final String THINGSPEAK_API_KEY_STRING = "2F0SWOE6NCBDQNOI";//replace your read key
    ...
    GoogleMap.OnMyLocationClickListener onMyLocationClickListener =
    ...
    public void onDraw(GoogleMap googleMap) {
        Location location = googleMap.getMyLocation();
        final Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?" + "saddr=" + location.getLatitude() + "," + location.getLongitude() + "&daddr=" + 11.0283 + "," + 77.023));
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters + "&key=AIzaSyD4qDkhyYL2n-gT1i7p-n_3yV7QugyJAYI";
...
// Drawing polyline in the Google Map for the i-th route
            if (lineOptions != null)
            {
                ...
                Toast.makeText(MapsActivity.this, "PolylineOptions cannot be null", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    class FetchThingspeakTask extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPreExecute() {
            Toast.makeText(MapsActivity.this,"Fetching Data from Server.Please Wait...",Toast.LENGTH_LONG).show();
        }
